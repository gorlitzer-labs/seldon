...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    beats: [
      { id: "ask", kicker: "you, speaking", heading: "It starts with a sentence.",
        body: ["You don't open six tools. You tell Demerzel what you want built, out loud, and the hive takes it from there."],
        focus: "demerzel", view: "surface",
        say: [{ text: "It begins the way you'd want it to: you just say what you want built, and Demerzel takes it from there.", look: "demerzel", view: "surface" }] },
      { id: "flow", kicker: "the whole hive", heading: "Then it runs itself.",
        body: ["apiary opens the room, foundation plans it, comb hands over the keys, factory keeps it on the rails, bifrost spreads it across your machines. One idea, walking itself to shipped — the weather CLI, live."],
        focus: null, view: "combo",
        say: [
          { text: "The idea lands in a room,", look: "apiary" },
          { text: "foundation gives it a plan,", look: "foundation" },
          { text: "comb hands over the keys,", look: "comb" },
          { text: "factory keeps it on the rails,", look: "factory" },
          { text: "and bifrost spreads the work across your machines.", look: "bifrost" },
        ] },
      ...
      { id: "shipped", kicker: "you, again", heading: "And it ends with Demerzel.",
        body: ["When it's done — or when it hits the one call only you can make — you hear it: the weather CLI is live. Or: Postgres or SQLite? The loop closes where it opened, on a voice."],
        focus: "demerzel", view: "surface",
        say: [{ text: "And it closes where it started. Demerzel tells you it shipped, or asks the one call that needs a human. That is the whole loop.", look: "demerzel", view: "surface" }] },
    ],
  },
  {
