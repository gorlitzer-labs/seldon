---
mode: agent
description: Create your lane's worktree + branch off fresh main, or open the PR when done. The git moves the workflow describes but nothing else automates.
---
