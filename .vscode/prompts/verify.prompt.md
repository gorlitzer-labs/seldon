---
mode: agent
description: The QA gate before a task is marked done. Light by default, escalates on risk. Records the result as a verified fact — a claim is a hypothesis until it passes.
---
