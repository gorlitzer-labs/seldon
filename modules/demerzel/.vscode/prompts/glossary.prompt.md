---
mode: agent
description: Pin the ubiquitous language — one canonical term per concept — before it propagates into schema and UI as contradictions. Writes docs/CONTEXT.md.
---
